...
fn get_count(deps: Deps) -> StdResult<CountResponse> {
    let state = STATE.load(deps.storage)?;
    Ok(CountResponse { count: state.count })
}

// #[cfg_attr(not(feature = "library"), entry_point)]
// pub fn query_owner(deps: Deps, _env: Env, msg: QueryOwn) -> StdResult<Binary> {
//     match msg {
//         QueryOwn::GetOwner {} => to_binary(&get_owner(deps)?),
//     }    
// }
